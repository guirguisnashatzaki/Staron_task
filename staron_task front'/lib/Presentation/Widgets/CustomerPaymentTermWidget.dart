...
class CustomerPaymentTermWidget extends StatefulWidget {
  DbHelper? db;
  CustomerPaymentTermWidget({Key? key,required this.db}) : super(key: key);

  @override
  State<CustomerPaymentTermWidget> createState() => _CustomerPaymentTermWidgetState();
}

class _CustomerPaymentTermWidgetState extends State<CustomerPaymentTermWidget> {

  final Dio dio = Dio();

  Future<List> getAccounts()async{
    Response response;
    response = await dio.get(baseURL+'customer_payments_terms');
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  IconButton(
                    onPressed: (){
                      Navigator.push(context, MaterialPageRoute(builder: (builder)=> CustomerPaymentTermAdd(update: true,object: widget.model, db: DbHelper(),)));
                  ...
                  IconButton(
                    onPressed: (){
                      ...
                      dio.delete(baseURL+"delCusPay/"+widget.model['termId'].toString()).whenComplete((){
